		...
		$("#favIcon").click(function(){
			if($("#favIcon").attr("class") == "glyphicon glyphicon-star-empty favouriteStar"){
				$.post( "favourites_newEntry.php", {
				  ...
				  .done(function() {
					$("#favIcon").attr("style", "color:rgb(255, 204, 0); font-size:35px;");
				...
				$.post( "favourites_removeEntry.php", {
					...
					subject_id: "<?php echo $subjectData['ID'] ?>"} )
				 .done(function() {
					$("#favIcon").attr("style", "color:grey; font-size:35px;");
							...
							<div class=\"media-body\">
								...
								<div style=\"font-size:10px\">
									...
									<span style=\"float:right; ".$displayEdit."\">
										<button type=\"button\" a href=\"#editModal\" role=\"button\" class=\"editTrashButton\" data-toggle=\"modal\" title=\"Kommentar bearbeiten\"> <span class=\"glyphicon glyphicon-pencil\"></span></button>
										<button type=\"button\" a href=\"#deleteModal\" role=\"button\" class=\"editTrashButton\" data-toggle=\"modal\" title=\"Kommentar löschen\"> <span class=\"glyphicon glyphicon-trash\"></span></button>
									</span>
