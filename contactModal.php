		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.includes("achievement")){
					alert("Du hast die Errungenschaft \"Verbesserer\" freigeschaltet! Schau gleich nach unter Profil > Errungenschaften.");
				}
				...
				$('.modal-body').html("<div class=\'alert alert-danger\'><span class=\'glyphicon glyphicon-info-sign\'></span> &nbsp; Bei der Übermittlung Deines Anliegens ist womöglich ein Fehler aufgetreten! Bitte probiere es erneut (oftmals liegt es am Server, sodass es beim zweiten Mal klappt); falls es immernoch nicht funktioniert, schreib uns: studienführer@vwi-karlsruhe.de.</div><button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\" onClick=\"window.location.reload()\">Schließen</button>");
				}
			}
		});
		e.preventDefault();
