...
$sql="
	INSERT INTO `ratings` (`subject_ID`, `crit1`, `crit2`, `crit3`, `crit4`, `crit5`, `recommendation`, `comment_title`, `comment_body`, `comment_rating`, `user_ID`, `time_stamp`)
	VALUES ('$subjectData[ID]', '$criterion1', '$criterion2', '$criterion3', '$criterion4', '$criterion5', '$recommendation', '$title', '$comment', 0, '$nameID', now())";
