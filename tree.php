...
<button onclick="changeRightMenu()" class="w3-bar-item w3-button w3-large">Feed auf- und zuklappen</button>
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:;right:0;" id="rightMenu">
...
$( document ).ready(function() {
	alert(
		"zusammen: " + ($('#treeMainContainer').width()+$('#rightMenu').width())
		+ "\n" +
...
<div class="container" id="treeMainContainer">
	<?php
